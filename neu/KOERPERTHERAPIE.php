...
<html lang="de">
	<head>
		...
		<title>Einzelbegleitung</title>
	</head>
	<body>
		<?php require("navbar.html"); ?>
		<div  id="content">
			<div class="images">
				<img style="float:left" src="img/BlumeX.jpg" alt="WollBlume"></img>
			</div>
				...
				<div class=" center60 container">
					<div class="noPadding col-md-12">
							<div class="lead mainTextColor">
								<h1 class="first">KÖRPERTHERAPIE &nbsp;-&nbsp; ÜBER DEN KÖRPER DIE SEELE HEILEN</h1>
								...
								<div class="message">
									...
									<span style="font-style:italic">„Tanz, das ist Rhythmus, Musik und Fließen, aber auch Verstehen, verstehen der körperlichen Zusammenhänge, Gespräch und Klärung des in der Gewebetiefe Erfahrenen. Dort, wo sich unser Verstehen trifft mit unserem Fühlen, dort öffnet sich der Raum für Heilung, für Tanz, für Leben.“ (Gabriele Fischer)</span></br></br>
									<h1>BIODYNAMISCHE KÖRPERTHERAPIE</h1>
									...
									<span style="font-style:italic">"Die Lust steckt im Körper. Lust ist das Spüren der zirkulierenden Lebensenergie.
									Dann ist es schön zu leben. Menschen in diesen Zustand zu führen ist das Grundprinzip meiner Arbeit" (Gerda Boyesen)</span></br></br>
									<h1>KÖRPERORIENTIERTE TRAUMATHERAPIE</h1>
									...
									<span style="font-style:italic">„Ein Trauma ist im Nervensystem gebunden. Durch einschneidende Ereignisse hat es seine volle Flexibilität verloren. Wir müssen ihm deshalb helfen, wieder zu seiner ganzen Spannbreite und Kraft zurück zu finden.“ (Dr. Peter A. Levine)</span></br></br>
									<h4>SYSTEMISCHE FAMILIENTHERAPIE</h4>
									Ein weiterer Ansatz ist die Systemische Familientherapie von Virgina Satir.
									...
									<span style="font-style:italic">„Ich glaube daran, dass das größte Geschenk, das ich von jemandem empfangen kann, ist, gesehen, gehört, verstanden und berührt zu werden. Das größte Geschenk, das ich geben kann, ist, den anderen zu sehen, zu hören, zu verstehen und zu berühren. Wenn dies geschieht, entsteht Beziehung“.(Virgina Satir) </span></br></br>
									<h4>GEWALTFREIE KOMMUNIKATION</h4>
									Die Methode der „Gewaltfreie Kommunikation“ stammt von Marshall B. Rosenberg.</br></br>
									<span style="font-style:italic">„Das Ziel im Leben ist es, all unser Lachen zu lachen und all unsere Tränen zu weinen. Was auch immer sich uns offenbart, es ist das Leben, das sich darin zeigt, und es ist immer ein Geschenk, sich damit zu verbinden.” </span></br></br>
									...
									<a class="mail" target="_blank" href="pdf/HHNienstedtenMontag.pdf">PDF (TODO)</a>, -->
								</div>
							</div>
						</div>
