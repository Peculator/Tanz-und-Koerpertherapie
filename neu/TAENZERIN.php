...
<html lang="de">
	<head>
		...
		<title>Die Tänzerin in dir</title>
	</head>
	<body>
		<?php require("navbar.html"); ?>
		<div id="content">
			<div class="images">
				<img style="float:left" src="img/BildTanz.jpg" alt="Tanz"></img>
			</div>
			...
			<div class=" main">
				<div class=" center60 container">
					<div class="noPadding col-md-12">
							...
							<!--p class="quote orange leftBorder">" Im Tanz ist der Mensch wirklich "</p>
<p class="quote orange rightBorder"><span class="orange author">G.F.</span></p-->

								<h1 class="first">TANZ&nbsp;-&nbsp;DIE TÄNZERIN IN DIR</h1>
								„Die Tänzerin in Dir“ ist ein Tanzangebot für Frauen, die ihren Körper
								in der Bewegung, im Tanz neu erfahren und über die gewohnten Muster von
								Bewegung hinaus tanzen möchten. Das Tanzen mit dem ganzen Körper und allen
								Sinnen möchte Sie dabei unterstützen, sich in allen Schichten und Dimensionen
								der Körperlichkeit wahrzunehmen, von hier aus das innere Wachstum zu fördern.
								Tanzen stärkt in uns die Fähigkeit zum authentischen lebendigen Ausdruck; so
								kann der Alltag positiv beeinflusst werden, und unsere Lebensqualität kann mit
								mehr Präsenz und Sensibilität bereichert werden. Tanz des Lebens mit all ihren
								Nuancen und Schattierungen lässt uns eine neue Form des Ausdrucks finden und das
								Leben in seiner pulsierenden Lebendigkeit neu zu erleben. </br></br>
								Wir arbeiten mit dem ganzheitlichen Ansatz „Heilende Kräfte im Tanz®“.</br></br>
								<span class="readmore orange">
								mehr lesen...
								</span>
								<div class="message">
									<h1>TIEFE VERBUNDENHEIT MIT DEM KÖRPER</h1>
...
<!-- Melden Sie sich gerne bei mir, wenn Sie Fragen haben oder einen Termin für ein persönliches Gespräch wünschen.  -->
									...
									<a class="mail" target="_blank" href="pdf/HHNienstedtenMontag.pdf">PDF (Montag)</a>,
									<a class="mail" target="_blank" href="pdf/HHNienstedtenMittwoch.pdf">PDF (Mittwoch)</a>
								</div>
							</div>
						</div>
