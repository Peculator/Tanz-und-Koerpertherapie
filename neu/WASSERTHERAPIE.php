...
<html lang="de">
	<head>
		...
		<title>Körpertherapie im Wasser</title>
	</head>
	<body>
		...
		<div id="content">
			...
			<div class="images">
				<div id="slideshow">
					<div style="width:100%"><img src="img/BildPhilosophie.jpg" alt="Gras in der Lüneburger Heide" width="100%" height="100%" border="0"/></div>
					<div style="width:100%"><img src="img/BildKoerpertherapieimWasser.jpg" alt="Wasserbild" width="100%" height="100%" border="0"/></div>
				</div>
			</div>
				...
				<div class=" center60 container">
					<div class="noPadding col-md-12">
							<div class="lead mainTextColor">
								<h1 class="first">KÖRPERTHERAPIE IM WASSER</h1>
Die Körperarbeit im Wasser bietet mit ihrem ganzheitlichen Ansatz die Möglichkeit, auf allen Ebenen den Heilungsprozess zu fördern. Das feine Zusammenspiel aus Wasser, Getragensein, Gahaltensein, Nähe und Berührung führt uns direkt zu einer Entspannung, die das natürliche und ursprüngliche Gleichgewicht zwischen Körper und Seele wiederherstellt und die Selbstheilungskräfte des Körpers aktiviert. Die ganzheitliche Körperarbeit im Wasser bietet eine Möglichkeit, besonders tiefgreifende Traumata aus frühster Kindheit zu heilen.</br></br>
Wasser ist das Urelement und ist die Grundlage allen Lebens auf unserer Erde. Der Mensch besteht zu über 80 % aus Wasser. Die Wasserarbeit zeichnet sich dadurch aus, dass sie ganz auf manipulative Techniken verzichtet und dem Klienten den Weg zum eigenen, ursprünglich-natürlichen Bewegungsfluss im Wasser öffnet. Die einfühlsame Haltung, bei der Sie mit dem ganzen Körper im warmen Wasser auf Händen getragen werden, lässt uns die weichen, wiegenden Bewegungen des Wassers mit dem Wasser in uns verbinden, und die Grenzen für neue Erfahrungen der Körperlichkeit werden erweitert. </br></br>
Die Wasserarbeit ist ein wichtiger Bestandteil der ganzheitlichen biodynamischen Körperarbeit. 
								...
								mehr lesen...
								  ...
								  <div class="message">
<h1>VON ANBEGINN AN GEHALTEN- UND GETRAGENSEIN</h1>
...
<h1>DIE HEILENDE KRAFT DES WASSERS</h1>
...
<ul>
									<li>Auflösung von Schockerlebnissen und Traumaerfahrungen, ganz besonders bei pränatalen (vorgeburtlichen) Verletzungen.</li>
									<li>Aufarbeitung von negativen Geburtserlebnissen,</li>
									<li>Anbindung an Gefühle von Urvertrauen und tiefer Geborgenheit,</li>
									<li>Steigerung des Wohlbefindens und der Leistungsfähigkeit,</li>
									<li>Verbesserung der Beweglichkeit im ganzen Körper,</li>
									<li>Lösung von Spannungen im Körper, Geist und Seele,</li>
									<li>Aktivierung der Selbstheilungskräfte,</li>
									<li>Intensivierung des Zugangs zur Selbstwahrnehmung.</li>
								</ul>
...
Die Wasserarbeit ist grundsätzlich für alle Menschen geeignet: für Schwangere; für alt und jung; für Menschen, die Angst vor dem Wasser haben; auch für Nichtschwimmer und Menschen mit körperlichen Einschränkungen.		
				...
				var width_nine = $(window).width();
				var ratio = 1296/417;
				var height = width_nine/ratio;
				$('#slideshow').fadeSlideShow({
					width:width_nine, // Weite der Slideshow
					height:height, // Höhe der Slideshow
					speed:6000, // Geschwindigkeit der Übergangsanimation
					interval:5000 // Zeit, bis ein neues Bild eingeblendet wird (1000 = 1 Sekunde)
				});
